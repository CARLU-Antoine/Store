...
var BaseComponent = class _BaseComponent {
  ...
  ngOnDestroy() {
    ...
    this.themeChangeListeners.forEach((callback) => R2.off("theme:change", callback));
  }
  _loadStyles() {
    const _load = () => {
...
var DomHandler = class _DomHandler {
  ...
  static getViewport() {
    let win = window, d = document, e = d.documentElement, g2 = d.getElementsByTagName("body")[0], w = win.innerWidth || e.clientWidth || g2.clientWidth, h = win.innerHeight || e.clientHeight || g2.clientHeight;
    return {
      width: w,
      height: h
    };
