import {
  ...
  s2,
  z2 as z
} from "./chunk-U65MY234.js";
import {
  DOCUMENT
} from "./chunk-ROU7DOWJ.js";
import {
  Injectable,
  InjectionToken,
  PLATFORM_ID,
...
var S = {
  ...
  getCommonStyleSheet({
    ...
    let n = this.getCommon({
      ...
      set: o,
      defaults: a2
    }), l = Object.entries(s3).reduce((i2, [c, m2]) => i2.push(`${c}="${m2}"`) && i2, []).join(" ");
  ...
  getStyleSheet({
    ...
    let n = {
      ...
      set: o,
      defaults: a2
    }, l = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, i2 = Object.entries(s3).reduce((m2, [u, p2]) => m2.push(`${u}="${p2}"`) && m2, []).join(" ");
...
var g = {
  ...
  transformCSS(e = "", t, r = "style", s3) {
    return S.transformCSS(e, t, s3, r, this.options, {
      layerNames: this.setLayerNames.bind(this)
    }, this.defaults);
  },
...
//# sourceMappingURL=chunk-JWRZG5FK.js.map
